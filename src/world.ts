...
export function stockAt(c: Corp, sys: number, k: string): number{ var s = c.stock[sys]; return (s && s[k]) || 0; }
...
export function hasBranch(c: Corp, w: World): boolean{ return w.branches.some(function (b) { return b.corp === c.id; }); }
