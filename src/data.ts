...
export const COMPS: Comp[] = [
  ...
  { key:"eng2",  name:"Ходовой двигатель Mk2", short:"ход Mk2", diff:1500, work:4, base:34, glyph:"tri", mult:1.4 },
  { key:"eng3",  name:"Ходовой двигатель Mk3", short:"ход Mk3", diff:2600, work:6, base:52, glyph:"tri", mult:1.9 },
  { key:"eng4",  name:"Ходовой двигатель Mk4", short:"ход Mk4", diff:4000, work:8, base:78, glyph:"tri", mult:2.5 }
];
...
export const MARKDIFF  = [1300, 2500, 4000, 5800];
