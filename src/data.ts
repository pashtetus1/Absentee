...
import type { Arm, BType, ColTech, Comp, Mark, Move, PType, Part, Tech, VType, WorldClass } from "./types";
...
export const TEMPLATE = [
  { name:"Тайко Дриллинг",   color:"#6fd39b", craft:"буры",      nerve:0.9,
    apt:{ drill:1.9, hull:0.7, hold:0.6, drive:0.4, gkit:0.4, life:0.4, pod:0.35, eng:0.5, arm:0.7,
          temperate:0.7, cold:1.2, dry:0.8, hot:1.4, gas:0.5 } },
  { name:"Ново-Кеплер Авиа", color:"#ff8b5e", craft:"самолёты",  nerve:1.25,
    apt:{ hull:1.9, drive:0.85, gkit:0.9, hold:0.7, life:0.5, drill:0.4, pod:0.35, eng:1.6, arm:1.5,
          temperate:0.9, cold:0.7, dry:0.8, hot:0.6, gas:1.5 } },
  { name:"Дом чая Ланьхуа",  color:"#dd7ec6", craft:"чай",       nerve:0.6,
    apt:{ pod:2.0, hold:0.9, life:0.7, hull:0.35, drill:0.3, drive:0.3, gkit:0.3, eng:0.35, arm:0.3,
          temperate:1.7, cold:0.5, dry:0.9, hot:0.3, gas:0.4 } },
  { name:"Гелиос-Прайм",     color:"#4ec4e6", craft:"механика",  nerve:1.05,
    apt:{ drive:1.55, gkit:1.6, life:1.25, hull:0.8, hold:0.5, drill:0.5, pod:0.35, eng:1.7, arm:1.3,
          temperate:0.8, cold:1.0, dry:0.7, hot:1.2, gas:1.1 } },
  { name:"Синдикат Веги",    color:"#f2b33d", craft:"перевозки", nerve:0.85,
    apt:{ hold:1.85, life:0.85, pod:0.8, hull:0.6, drill:0.55, drive:0.45, gkit:0.5, eng:1.2, arm:0.8,
