// Проверка честности переезда: два файла на одном сиде обязаны дать
// побитово одинаковую партию.
//
// Журнал, п.9: "старый и новый файл на одном сиде дают побитово одинаковую
...
for (const seed of SEEDS) {
  ...
  if (diffs.length) { bad++; console.log("сид " + seed + ": РАСХОЖДЕНИЕ"); diffs.forEach((d) => console.log(d)); }
  else console.log("сид " + seed + ": совпадает (" + da.length + " значений на " + YEARS + " году)");
}
